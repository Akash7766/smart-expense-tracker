    ...
    <div className="min-h-screen flex items-center justify-center bg-surface p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          ...
          <p className="text-sm text-slate-500 mt-1">Use Google or email to get started</p>
        </div>
        ...
        <Card className="p-6 space-y-5">
          ...
          <form onSubmit={handleSignup} className={`space-y-4 ${!firebaseConfigured ? 'pointer-events-none opacity-50' : ''}`}>
            <div>
